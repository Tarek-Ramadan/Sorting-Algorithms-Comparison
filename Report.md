...
![](Report.001.png)**Test Case 1**: Array will start with size of 100 and increment by 100 until 1000, Array values ranges between 0 and 1200 and the Array is initially inserted as **Random Input**.
...
![](Report.004.png)**Test case 2:** The** array will start with size of 100 and increment by 100 until 500, Array values ranges between 0 and 1200 and the Array is initially inserted as **Sorted**.
...
![](Report.005.png)**Test case 3**: Array will start with size of 100 and increment by 100 until 800, Array values ranges between 0 and 1200 and the Array is initially inserted as **Reverse Sorted**.
